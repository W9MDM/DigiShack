...
- [FlexRadio (direct)](#flexradio-direct) — 14 settings
...
| Decoder depth | `flex.decodeDepth` | number | `2` | 1-4. Depth 2 (~0.55s per window) is the live default; 3 fits with less margin; 4 takes ~11s and cannot keep up with the 15s FT8 cycle. |
